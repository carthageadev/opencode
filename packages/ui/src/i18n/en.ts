const source = {
  ...
  "ui.tool.browser.back": "Went back on {{page}}",
  "ui.tool.browser.forward": "Went forward on {{page}}",
  "ui.tool.browser.reloaded": "Reloaded {{page}}",
  "ui.tool.browser.stopped": "Stopped loading {{page}}",
  "ui.tool.browser.read": "Read {{page}}",
  "ui.tool.browser.searched": "Searched {{page}}",
  "ui.tool.browser.inspected": "Inspected {{page}}",
  "ui.tool.browser.waited": "Waited on {{page}}",
  "ui.tool.browser.clicked": "Clicked on {{page}}",
  "ui.tool.browser.hovered": "Hovered over {{page}}",
  "ui.tool.browser.dragged": "Dragged on {{page}}",
  "ui.tool.browser.filled": "Filled a form on {{page}}",
  "ui.tool.browser.interacted": "Interacted with {{page}}",
  "ui.tool.browser.scrolled": "Scrolled {{page}}",
  "ui.tool.browser.handled": "Handled a dialog on {{page}}",
  "ui.tool.browser.files": "Managed files on {{page}}",
  "ui.tool.browser.analyzed": "Analyzed {{page}}",
